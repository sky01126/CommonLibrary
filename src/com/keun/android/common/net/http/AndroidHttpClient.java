...
package com.keun.android.common.net.http;
...
public final class AndroidHttpClient implements HttpClient {
    ...
    private static String toCurl(HttpUriRequest request, boolean logAuthToken)
        ...
        // If this is a wrapped request, use the URI from the original request
        // instead. getURI() on the wrapper seems to return a relative URI. We
        // want an absolute URI.
    ...
    // /**
    // * Returns the date of the given HTTP date string. This method can
    // identify
    ...
    // * <a
    // href="http://www.opengroup.org/onlinepubs/007908799/xsh/asctime.html">ANSI
    // * C's asctime()</a>.
    // *
